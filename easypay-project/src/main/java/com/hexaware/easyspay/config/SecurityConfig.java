...
/*
 * Security configuration for the EasyPay system, handling authentication and authorization settings.
 * Defines beans for user details service, password encoder, authentication provider, and security filter chain.
 * Configures access control based on roles and session management for stateless authentication.
 * 
