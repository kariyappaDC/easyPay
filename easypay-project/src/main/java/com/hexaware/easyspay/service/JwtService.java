...
/**
 * Service for generating and validating JSON Web Tokens (JWTs) for user authentication.
 * Provides methods to create, extract claims, and validate JWTs using a secure signing key.
 * 
